...
function App() {
  ...
  const [messages, setMessages] = useState([
    {
    text: "Hello, I'm FajGPT! I am a virtual assistant powered by GPT-4, one of the most advanced models in OpenAI's Generalized Autoregressive Pre-trained Transformer (GPT) series.  My primary purpose is to assist users by providing information, answering questions, helping with tasks like text generation, tutoring in various subjects, brainstorming, and more. I aim to be a versatile tool for a wide array of text-based tasks. ",
    isBot: true,
  }
])
